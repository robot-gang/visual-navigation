...
if __name__ == '__main__':
    ...
    a = Trajectory(area='area3', h_pos=start_human_pos, c_pos=start_camera_pos, h_speed=1, c_speed=0.4, identity=48, pose=20, total_time=1, num_images=2, out_dir='/home/rex/test', seq_name='test_moving')
